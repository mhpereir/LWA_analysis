...
#     files_by_member = []
#     for m in ensemble_list:
#         filepat = f"{path_to_data}/{m}/day/{var}/gn/v20190429/{var}_day_CanESM5_historical_{m}_gn_18500101-20141231_2x2_bil.nc"
#         files = sorted(glob.glob(filepat))
#         if not files:
#             raise FileNotFoundError(f"No files matched for {m}")
#         files_by_member.append(files)
...
#     """
#     filepat = f"{ERA5_LWA_ROOT}/z{zg_coord}/LWA_day_era5_*.2deg.{zg_coord}.nc"
#     files = sorted(glob.glob(filepat))
#     if not files:
