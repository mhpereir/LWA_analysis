...
#PBS -S /bin/bash
#PBS -N bayesian_lwa_deltaT_corr
...
SEASON="JJA"
LWA_VARS=(bothLWA) ### (LWA LWA_a LWA_c)
REGIONS=(pnw_bartusek) 
BAYESIAN_MODEL="both_lwa_ar1_studentt"
# ==================================


SCRIPT_PATH="/home/mhpereir/LWA_analysis/scripts/Bayesian_posteriors_plotting_bothLWA_2.py"
...
/usr/bin/time -v python "$SCRIPT_PATH" --bayesian_model "$BAYESIAN_MODEL" --region "$REGION" --season "$SEASON" --lwa_var "$LWA_VAR" 
