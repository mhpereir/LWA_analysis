...
SCRIPT_PATH="/home/mhpereir/LWA_analysis/scripts/Bayesian_posteriors_plotting_bothLWA.py"
...
/usr/bin/time -v python "$SCRIPT_PATH" --region "$REGION" --season "$SEASON" --lwa_var "$LWA_VAR" 
